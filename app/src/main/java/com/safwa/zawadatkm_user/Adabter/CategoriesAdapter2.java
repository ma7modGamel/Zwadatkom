...
public class CategoriesAdapter2 extends PagedListAdapter<CategoriesModel.Datum, CategoriesAdapter2.CategoriesVmodel> {
    ...
    public CategoriesVmodel onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.itemcatigories, parent, false);
